 ...
 */
export const generateStructurizrDsl = (
	model: ArchitectureModel,
	sourcePath = 'Architecture Markdown'
): string => {
	...
	const workspaceTitle = model.metadata?.title ?? 'Architecture';
	const lines = [
		`// Generated from ${ sourcePath }. Do not edit manually.`,
		`workspace ${ quoted( workspaceTitle ) } {`,
